...
HD_PWD='C:/ece4743/lab8/empty_template.runs/blk_mem_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen.tcl
