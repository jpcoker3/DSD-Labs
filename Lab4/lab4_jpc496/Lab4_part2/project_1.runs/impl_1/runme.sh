...
HD_PWD='C:/ece4743/Lab4_part2/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4dpath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab4dpath.tcl -notrace
