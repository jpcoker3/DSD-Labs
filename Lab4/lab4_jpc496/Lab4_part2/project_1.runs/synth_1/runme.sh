...
HD_PWD='C:/ece4743/Lab4_part2/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4dpath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab4dpath.tcl
