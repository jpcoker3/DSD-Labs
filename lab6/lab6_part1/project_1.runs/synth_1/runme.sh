...
HD_PWD='C:/ece4743/lab6/lab6_part1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6dpath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab6dpath.tcl
