...
HD_PWD='C:/ece4743/lab6/lab6_part1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6dpath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab6dpath.tcl -notrace
