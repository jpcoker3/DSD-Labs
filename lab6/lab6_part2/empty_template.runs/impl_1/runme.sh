...
HD_PWD='C:/ece4743/lab6/lab6_part2/empty_template.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_testbench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw_testbench.tcl -notrace
