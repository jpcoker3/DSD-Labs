...
HD_PWD='C:/ece4743/lab6/lab6_part2/empty_template.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_testbench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_testbench.tcl
