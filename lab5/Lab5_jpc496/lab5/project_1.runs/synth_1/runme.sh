...
HD_PWD='C:/ece4743/lab5/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5dpath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab5dpath.tcl
