...
HD_PWD='C:/ece4743/lab5/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5dpath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab5dpath.tcl -notrace
