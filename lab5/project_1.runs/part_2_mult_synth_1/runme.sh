...
HD_PWD='C:/ece4743/lab5/project_1.runs/part_2_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log part_2_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source part_2_mult.tcl
