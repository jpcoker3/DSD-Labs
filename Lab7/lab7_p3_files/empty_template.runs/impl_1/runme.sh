...
HD_PWD='C:/ece4743/Lab7/lab7_p3_files/empty_template.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log timertop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source timertop.tcl -notrace
