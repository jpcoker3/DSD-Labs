...
HD_PWD='C:/ece4743/Lab7/lab7_p3_files/empty_template.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timertop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timertop.tcl
