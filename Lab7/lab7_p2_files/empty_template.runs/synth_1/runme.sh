...
HD_PWD='C:/ece4743/Lab7/lab7_p2_files/empty_template.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timer32bus.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timer32bus.tcl
