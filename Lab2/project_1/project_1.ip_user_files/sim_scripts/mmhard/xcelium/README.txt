...
#
# Generated by export_simulation on Tue Sep 20 19:36:00 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './mmhard.sh' script.
...
./mmhard.sh -noclean_files

For more information on the script, please type './mmhard.sh -help'.
