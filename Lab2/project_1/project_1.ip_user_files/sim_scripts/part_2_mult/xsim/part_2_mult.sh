...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot part_2_mult xil_defaultlib.part_2_mult -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim part_2_mult -key {Behavioral:sim_1:Functional:part_2_mult} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb part_2_mult.wdb xsim.dir)
