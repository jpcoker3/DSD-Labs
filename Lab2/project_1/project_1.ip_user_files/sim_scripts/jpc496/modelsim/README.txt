...
#
# Generated by export_simulation on Tue Sep 27 18:38:39 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './jpc496.sh' script.
...
./jpc496.sh -noclean_files

For more information on the script, please type './jpc496.sh -help'.
