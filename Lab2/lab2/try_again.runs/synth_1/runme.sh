...
HD_PWD='C:/ece4743/Lab2/lab2/try_again.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log max3sint16b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source max3sint16b.tcl
