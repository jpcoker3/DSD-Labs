...
HD_PWD='C:/ece4743/Lab2/lab2/try_again.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log max3sint16b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source max3sint16b.tcl -notrace
