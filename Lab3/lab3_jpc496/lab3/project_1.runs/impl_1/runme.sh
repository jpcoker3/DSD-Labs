...
HD_PWD='C:/ece4743/lab3/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log satadd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source satadd.tcl -notrace
