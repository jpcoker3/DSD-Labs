...
HD_PWD='C:/ece4743/Lab3_part2/project_1.runs/ip_addsub_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_addsub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_addsub.tcl
