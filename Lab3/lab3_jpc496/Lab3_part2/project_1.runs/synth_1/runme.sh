...
HD_PWD='C:/ece4743/Lab3/lab3_jpc496/Lab3_part2/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log satadd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source satadd.tcl
